...
func ladderLength1(beginWord string, endWord string, wordList []string) int {
	...
	// endWord不在wordList中 或 遍历不到
	if hash[endWord] == false {
		return 0
	}
	return res
}
